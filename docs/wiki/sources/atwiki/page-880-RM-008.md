# 対バイオロン法 (RM-008) (page 880)

出典: https://w.atwiki.jp/renst/pages/880.html
カードID: RM-008
取得: 2026-06-09T04:44:26.798Z
...
- 通常はDAのユニットしか対象にとれないが、京介変身体や音撃と組み合わせれば効果の適用範囲がぐっと広がる。

- サイズ指定がないので、音撃を使用すればエンジンオーG6や究極大獣神といった強力なユニットも除去できる。
...
(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a08d7b2b5f019d04',t:'MTc4MDk4MDI2Ng=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();
