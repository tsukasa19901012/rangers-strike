# 爆竜ディメノコドン (RS-168) (page 95)

出典: https://w.atwiki.jp/renst/pages/95.html
カードID: RS-168
...
【爆竜必殺クロスサンダー】これが同カテゴリのLユニットからコンビネーションするとき、次の効果を発動できる⇒BP5000以下のユニットを自軍と敵軍の場から1体ずつ選んで撃破する。
...
- 守護獣ティラノザウルスの【ティラノソニック】を恒常的に使用できるがＪＣというのがハードルが高い。自軍側の生贄を如何に確保するかが鍵だろう。
