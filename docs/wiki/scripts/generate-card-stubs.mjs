#!/usr/bin/env node
/**
 * legend49-atwiki-pages.json から未作成の docs/wiki/cards/RS-*.md を生成。
 */
...
const PAGES = path.join(packageRoot, "src/legend49-atwiki-pages.json");
...
function stub(cardId, { page, name, expansion, expansionTitle }) {
...
収録: 第${expansion}弾（${expansionTitle}）
