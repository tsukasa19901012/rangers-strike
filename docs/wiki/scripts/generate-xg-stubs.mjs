#!/usr/bin/env node
/**
 * xg-atwiki-pages.json から docs/wiki/cards/{XG,SX,XP}-*.md を生成
 */
...
const PAGES = path.join(packageRoot, "src/xg-atwiki-pages.json");
...
function stub(cardId, { page, name, setTitle }) {
