...
**日付:** 2026-06-11（キーワード注記更新）
**対象:** Wiki 全カード 1849 枚

> **注:** 2026-06-11 時点でレジスト・クロス・ブラスト・モーフ反応・チェイス骨格・ウイング部分実装済。
> 静的 ABCDE 区分の C 理由 `engine_pattern_text` は未自動再分類。キーワードギャップは [keyword-implementation.md](./keyword-implementation.md) を正とする。
...
| **C** Engine 改修必要 | コマンダー・母艦・State 書き換え等。キーワード骨格未実装は 2026-06-11 以降縮小 | 324 | **17.5%** |
...
- **ウイング / チェイス / JC・RC** — 部分実装済（[keyword-implementation.md](./keyword-implementation.md)）
