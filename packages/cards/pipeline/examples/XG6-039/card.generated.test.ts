/**
 * Auto-generated pipeline test for XG6-039 (スタッグフォン)
 * Regenerate: npm run pipeline:card -- XG6-039
 */
...
describe("XG6-039 スタッグフォン (pipeline)", () => {
  ...
  it("has expected card id and effects", () => {
    expect(doc.id).toBe("XG6-039");
    expect(doc.effects?.length ?? 0).toBeGreaterThan(0);
  });

  it.skip("named_e382b9e382bf — effect uses fallback_handler — engine test required", () => {});
});
