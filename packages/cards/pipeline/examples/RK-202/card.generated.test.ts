/**
 * Auto-generated pipeline test for RK-202 (仮面ライダー王蛇ブランク体)
 * Regenerate: npm run pipeline:card -- RK-202
 */
...
describe("RK-202 仮面ライダー王蛇ブランク体 (pipeline)", () => {
