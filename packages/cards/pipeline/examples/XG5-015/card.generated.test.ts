/**
 * Auto-generated pipeline test for XG5-015 (スティライザー)
 * Regenerate: npm run pipeline:card -- XG5-015
 */
...
describe("XG5-015 スティライザー (pipeline)", () => {
  ...
  it("has expected card id and effects", () => {
    expect(doc.id).toBe("XG5-015");
    expect(doc.effects?.length ?? 0).toBeGreaterThan(0);
  });

  it.skip("named_e382b9e38386 — effect uses fallback_handler — engine test required", () => {});
});
