/**
 * Auto-generated pipeline test for XG6-004 (フルブラスト・アクション)
 * Regenerate: npm run pipeline:card -- XG6-004
 */
...
describe("XG6-004 フルブラスト・アクション (pipeline)", () => {
  ...
  it("has expected card id and effects", () => {
    expect(doc.id).toBe("XG6-004");
    expect(doc.effects?.length ?? 0).toBeGreaterThan(0);
  });

  it.skip("named_e38395e383ab — effect uses fallback_handler — engine test required", () => {});
});
