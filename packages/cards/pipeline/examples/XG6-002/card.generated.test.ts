/**
 * Auto-generated pipeline test for XG6-002 (銀河超越・三神合体)
 * Regenerate: npm run pipeline:card -- XG6-002
 */
...
describe("XG6-002 銀河超越・三神合体 (pipeline)", () => {
  ...
  it("has expected card id and effects", () => {
    expect(doc.id).toBe("XG6-002");
    expect(doc.effects?.length ?? 0).toBeGreaterThan(0);
  });

  it.skip("named_e98a80e6b2b3 — effect uses fallback_handler — engine test required", () => {});
});
