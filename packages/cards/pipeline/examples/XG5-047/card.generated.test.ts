/**
 * Auto-generated pipeline test for XG5-047 (キューユソウル)
 * Regenerate: npm run pipeline:card -- XG5-047
 */
...
describe("XG5-047 キューユソウル (pipeline)", () => {
  ...
  it("has expected card id and effects", () => {
    expect(doc.id).toBe("XG5-047");
    expect(doc.effects?.length ?? 0).toBeGreaterThan(0);
  });

  it.skip("named_e382ade383a5 — effect uses fallback_handler — engine test required", () => {});
});
