/**
 * Auto-generated pipeline test for RS-347 (スーパーフォーメーション)
 * Regenerate: npm run pipeline:card -- RS-347
 */
...
describe("RS-347 スーパーフォーメーション (pipeline)", () => {
