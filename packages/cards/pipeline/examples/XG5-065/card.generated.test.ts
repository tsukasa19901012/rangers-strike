/**
 * Auto-generated pipeline test for XG5-065 (タイムベント)
 * Regenerate: npm run pipeline:card -- XG5-065
 */
...
describe("XG5-065 タイムベント (pipeline)", () => {
  ...
  it("has expected card id and effects", () => {
    expect(doc.id).toBe("XG5-065");
    expect(doc.effects?.length ?? 0).toBeGreaterThan(0);
  });

  it.skip("named_e382bfe382a4 — effect uses fallback_handler — engine test required", () => {});
});
