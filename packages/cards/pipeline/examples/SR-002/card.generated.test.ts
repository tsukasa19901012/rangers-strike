/**
 * Auto-generated pipeline test for SR-002 (スーパーフォーメーション)
 * Regenerate: npm run pipeline:card -- SR-002
 */
...
describe("SR-002 スーパーフォーメーション (pipeline)", () => {
