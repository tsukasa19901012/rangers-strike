/**
 * Auto-generated pipeline test for XG5-048 (パーフェクター)
 * Regenerate: npm run pipeline:card -- XG5-048
 */
...
describe("XG5-048 パーフェクター (pipeline)", () => {
  ...
  it("has expected card id and effects", () => {
    expect(doc.id).toBe("XG5-048");
    expect(doc.effects?.length ?? 0).toBeGreaterThan(0);
  });

  it.skip("named_e38391e383bc — effect uses fallback_handler — engine test required", () => {});
});
