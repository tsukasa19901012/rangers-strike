/**
 * Auto-generated pipeline test for XG1-078 (コピーベント)
 * Regenerate: npm run pipeline:card -- XG1-078
 */
...
describe("XG1-078 コピーベント (pipeline)", () => {
  ...
  it("has expected card id and effects", () => {
    expect(doc.id).toBe("XG1-078");
    expect(doc.effects?.length ?? 0).toBeGreaterThan(0);
  });

  it.skip("named_e382b3e38394 — effect uses fallback_handler — engine test required", () => {});
});
