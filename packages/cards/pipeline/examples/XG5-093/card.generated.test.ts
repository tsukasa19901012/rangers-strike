/**
 * Auto-generated pipeline test for XG5-093 (ダブルブラザーパワー)
 * Regenerate: npm run pipeline:card -- XG5-093
 */
...
describe("XG5-093 ダブルブラザーパワー (pipeline)", () => {
  ...
  it("has expected card id and effects", () => {
    expect(doc.id).toBe("XG5-093");
    expect(doc.effects?.length ?? 0).toBeGreaterThan(0);
  });

  it.skip("named_e38380e38396 — effect uses fallback_handler — engine test required", () => {});
});
