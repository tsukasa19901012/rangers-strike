/**
 * Auto-generated pipeline test for XG6-015 (爆竜パラサロッキル)
 * Regenerate: npm run pipeline:card -- XG6-015
 */
...
describe("XG6-015 爆竜パラサロッキル (pipeline)", () => {
