/**
 * Auto-generated pipeline test for RS-526 (スーパーハイウェイバスター)
 * Regenerate: npm run pipeline:card -- RS-526
 */
...
describe("RS-526 スーパーハイウェイバスター (pipeline)", () => {
