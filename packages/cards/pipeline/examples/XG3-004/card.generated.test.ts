/**
 * Auto-generated pipeline test for XG3-004 (芋長の芋ヨーカン)
 * Regenerate: npm run pipeline:card -- XG3-004
 */
...
describe("XG3-004 芋長の芋ヨーカン (pipeline)", () => {
  ...
  it("has expected card id and effects", () => {
    expect(doc.id).toBe("XG3-004");
    expect(doc.effects?.length ?? 0).toBeGreaterThan(0);
  });

  it.skip("named_e88a8be995b7 — effect uses fallback_handler — engine test required", () => {});
});
