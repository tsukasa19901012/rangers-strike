/**
 * Auto-generated pipeline test for PR-025 (スーパーハイウェイバスター)
 * Regenerate: npm run pipeline:card -- PR-025
 */
...
describe("PR-025 スーパーハイウェイバスター (pipeline)", () => {
