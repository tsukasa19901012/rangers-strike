...
export const CATCHALL_GRANT_KEYWORD_PREFIXES =
...
/** @deprecated use isCatchallGrantKeyword for runtime routing */
export const HASH_GRANT_KEYWORD_PREFIXES = CATCHALL_GRANT_KEYWORD_PREFIXES;
